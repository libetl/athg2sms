...
public class ConvSetEditActivity extends Activity {
	...
	private void notAllowedChar () {
		...
		builder.setMessage ("No '#' in Conv Set name please.")
		...
		this.findViewById (R.id.modify).setOnClickListener (
		        new OnClickListener () {
			        ...
			        public void onClick (View v) {
				        ...
				        final String newCs = ((TextView) thiz
				        ...
				        if (newCs.indexOf ('#') != -1) {
					        ...
					        thiz.map.put (
					                "sent",
					                ((TextView) thiz.findViewById (R.id.cssent))
					                        .getText ().toString ()
					                        .replace ("[\\n]", "\n")
					                        .replace ("[\\t]", "\t"));
					        SettingsFactory.common ()
					                .putSet (thiz.cs, thiz.map);
					        thiz.finish ();
				        }
			        }
